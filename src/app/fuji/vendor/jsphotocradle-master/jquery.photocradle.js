...
$.photocradle.service.flickr = function ( params, loadHandler ) {
  var 
    ...
    defaultFlickrParams = {
      ...
      imageSizes: 
      {
        thumbnail: $.photocradle.flickrImageSizes.medium,
        preview: $.photocradle.flickrImageSizes.medium640,
        original: $.photocradle.flickrImageSizes.original
      }
    };
